              ...
              ?>
                <div class="page-navi__item">
                  <a href="<?php echo get_permalink($prev->ID); ?>" class="page-navi__link">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/prev.png" alt="前へ" class="page-navi__img" />
                    <div class="post-prev">
              ...
              ?>
                <div class="page-navi__item">
                  <a href="<?php echo get_permalink($next->ID); ?>" class="page-navi__link">
                    ...
                    <img src="<?php echo get_template_directory_uri(); ?>/images/next.png" alt="次へ" class="page-navi__img" />
                  </a>
                </div>
              <?php endif; ?>
            </div>
